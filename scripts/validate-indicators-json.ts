...
import { safeValidateIndicatorsRoot, formatZodErrors } from '../src/lib/types/indicators-json';
...
Checks performed:
  ...
  Pass 1 — Zod schema
    · indicator IDs match IND001..IND200
  ...
  Pass 2 — Lookup CSV consistency
    ...
    Note: system ids are already enforced by Pass 1 via z.nativeEnum(SystemIDEnum).
`);
}
