	...
	<div class="card-body space-y-5">
		...
		<div>
			...
			<div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
				<!-- JSON -->
				<button
					class="group border-base-300 hover:border-primary hover:bg-primary/5 flex items-center gap-3 rounded-lg border px-4 py-3 text-left transition-colors duration-150 cursor-pointer"
					onclick={onDownloadJSON}
				>
					<svg xmlns="http://www.w3.org/2000/svg" class="text-base-content/35 group-hover:text-primary size-7 shrink-0 transition-colors duration-150" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
		...
		<div class="border-base-300 border-t pt-5">
			<p class="text-base-content/50 mb-3 text-xs font-semibold uppercase tracking-widest">Deep-dive workbooks</p>
			<p class="text-base-content/60 mb-4 text-sm">
				One pre-filled XLSX per selected UOA — indicator values and preliminary flags — delivered as a single ZIP.
			</p>
