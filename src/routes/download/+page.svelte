...
<DataGuard {hasData} variant="none">
	<div class="space-y-6">
		<!-- Stat bar -->
		<div class="bg-base-200/60 border-base-300 rounded-box border px-5 py-3 flex items-center gap-3">
			<svg xmlns="http://www.w3.org/2000/svg" class="text-success size-5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
				<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>
			</svg>
			<p class="text-sm">
				<strong>{flagged.length}</strong> unit{flagged.length !== 1 ? 's' : ''} of analysis processed and ready to export.
			</p>
		</div>

		<!-- Flat exports -->
		<div>
			<p class="text-base-content/50 mb-3 text-xs font-semibold uppercase tracking-widest">Export dataset</p>
			<div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
				<button
					class="group border-base-300 hover:border-primary hover:bg-primary/5 flex items-start gap-4 rounded-box border px-5 py-4 text-left transition-colors duration-150 cursor-pointer"
					onclick={handleJSON}
				>
					<svg xmlns="http://www.w3.org/2000/svg" class="text-base-content/35 group-hover:text-primary mt-0.5 size-7 shrink-0 transition-colors duration-150" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
						<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>
						<line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>
					</svg>
					<div>
						<p class="text-sm font-semibold">JSON</p>
						<p class="text-base-content/50 mt-0.5 text-xs">Nested hierarchical format. Ideal for programmatic use.</p>
					</div>
				</button>
				...
				>
					...
					<div>
						...
						<p class="text-base-content/50 mt-0.5 text-xs">Flat tabular. One row per UOA. Compatible with Excel, R, Python.</p>
					</div>
				</button>
				...
				>
					...
					<div>
						...
						<p class="text-base-content/50 mt-0.5 text-xs">Native workbook. Useful for sharing with non-technical audiences.</p>
					</div>
				</button>
			</div>
		</div>
		...
		<div class="card bg-base-100 border-base-300 border shadow-sm">
			<div class="card-body gap-4">
				<div>
					<p class="text-base-content/50 mb-1 text-xs font-semibold uppercase tracking-widest">Deep-dive workbooks</p>
					<h3 class="text-base font-semibold">Pre-populated XLSX per unit of analysis</h3>
					<p class="text-base-content/60 mt-1 text-sm">
						One workbook per selected UOA, pre-filled with indicator values and preliminary flags. Delivered as a single ZIP archive.
					</p>
				</div>
